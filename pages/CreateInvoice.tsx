...
const CreateInvoice: React.FC = () => {
    const { clients, products, addInvoice, getNextInvoiceId } = useAppContext();
    ...
    const [items, setItems] = useState<Partial<InvoiceItem>[]>([{ description: '', quantity: 1, price: 0 }]);
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-6 md:p-8 space-y-8">
            <h2 className="text-2xl font-bold text-secondary">Nova Fatura ({getNextInvoiceId()})</h2>
